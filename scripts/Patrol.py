...
class Patrol:
    ...
    def setProperty(self):
        ...
        self.paramEntries = [Entry(self.paramFrame, textvariable=self.paramVars[i], validate="focusout", validatecommand=lambda i=i: self.paramCallback(i), width=6) for i in range(len(names))]
        ...
        self.resetButton = Button(self.controlFrame, text="重置", state="disabled", command=self.main.setstate.urgentReset)
